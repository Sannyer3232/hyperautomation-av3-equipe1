...
def validar_todas_propostas(
    ...
    for proposta in propostas:
        ...
        try:
            ...
            status_fornecedor = (
                status_web.get(codigo_fornecedor)
                or status_web.get(fornecedor)
                or status_web.get(str(fornecedor).strip())
            )
            ...
            if not status_fornecedor or status_fornecedor.strip().lower() != "ativo":
